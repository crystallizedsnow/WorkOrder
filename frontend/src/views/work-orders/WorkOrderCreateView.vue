...
const form = reactive({ type: 1, title: '', content: '', priorityLevel: 1, flowId: undefined as string | undefined, deadline: undefined as Date | undefined })
